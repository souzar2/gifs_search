...
class _HomePageState extends State<HomePage> {
  ...
  Future <Map> _getGifs() async{
    ...
    if(_search == null){
      ...
      response = await http.get("https://api.giphy.com/v1/gifs/search?api_key=Q7jEiovVDR2yE9e1MjCOHVAMn5wwj536&q=$_search&limit=19&offset=$_offSet&rating=g&lang=pt");}
